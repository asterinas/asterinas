...
const LINUX_REBOOT_MAGIC2A: i32 = 0x28121969;
const LINUX_REBOOT_MAGIC2B: i32 = 0x05121996;
const LINUX_REBOOT_MAGIC2C: i32 = 0x16041998;
...
pub fn sys_reboot(
    ...
    if magic2 != LINUX_REBOOT_MAGIC2A
...
fn poweroff() -> ! {
    use ostd::arch::poweroff::poweroff;
