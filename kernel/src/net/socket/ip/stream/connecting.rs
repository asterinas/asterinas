...
impl ConnectingStream {
    pub fn new(
        ...
        let tcp_conn = match TcpConnection::new_connect(bound_port, remote_endpoint, observer) {
    ...
    pub fn into_result(self) -> ConnResult {
        ...
        match next_state {
            ...
            ConnectState::Refused => {
                ConnResult::Refused(InitStream::new_bound(self.tcp_conn.into_bound().unwrap()))
            }
        }
    }
