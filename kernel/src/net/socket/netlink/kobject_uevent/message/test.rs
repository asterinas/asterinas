...
use crate::{
    net::socket::{
        netlink::{
            ...
            AnyMulticastMessage, GroupIdSet, NetlinkSocketAddr, NetlinkUeventSocket,
        },
...
#[ktest]
fn test_multicast_synthetic_uevent() {
    ...
    NETLINK_SOCKET_TABLE
        .multicast(AnyMulticastMessage::Uevent(uevent_message))
        .unwrap();
