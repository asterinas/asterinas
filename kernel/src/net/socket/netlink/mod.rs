...
//! For example, the NETLINK_ROUTE protocol is used to retrieve or modify routing table entries.
...
pub(in crate::net) use route::{NetDeviceFlags, NetDeviceType};
pub use table::{is_valid_protocol, StandardNetlinkProtocol};

trait AnyNetlinkSocket: Send + Sync {}
