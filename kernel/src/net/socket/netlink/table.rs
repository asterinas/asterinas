...
pub struct NetlinkSocketTable {
    protocols: RwMutex<BTreeMap<NetlinkProtocolId, RwMutex<NetlinkProtocolSockets>>>,
}
...
impl NetlinkSocketTable {
    ...
    fn add_new_protocol(&self, protocol: NetlinkProtocolId) {
        ...
        let new_protocol = RwMutex::new(NetlinkProtocolSockets::new(protocol));
...
impl NetlinkProtocolSockets {
    ...
    fn bind(
        ...
        self.unitcast_sockets.insert(port, socket.clone());
