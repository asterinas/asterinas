...
use super::{
    header::CMessageSegmentHeader, impl_nlsegment_general, legacy::CRtGenMsg, NlAttr, NlMsgSegment,
    ReadBodyFromUser, ReadNlMsgSegmentFromUser, WriteBodyToUser,
};
use crate::{
    net::socket::netlink::route::message::{attr::addr::read_addr_attrs, NLMSG_ALIGN},
    prelude::*,
...
impl_nlsegment_general!(AddrSegment, AddrSegmentBody, CIfaddrMsg, read_addr_attrs);

impl ReadBodyFromUser for AddrSegmentBody {
    type LegacyType = CRtGenMsg;
    type CType = CIfaddrMsg;
}

impl WriteBodyToUser for AddrSegmentBody {}
