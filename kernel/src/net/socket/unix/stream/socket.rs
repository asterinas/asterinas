...
impl UnixStreamSocket {
    pub fn new(is_nonblocking: bool, socket_type: SockType) -> Arc<Self> {
        debug_assert_unix_stream_socket_type(socket_type);
...
fn debug_assert_unix_stream_socket_type(socket_type: SockType) {
    debug_assert!(socket_type == SockType::SOCK_STREAM || socket_type == SockType::SOCK_SEQPACKET);
}
