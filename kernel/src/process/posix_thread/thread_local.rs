...
use crate::{
    ...
    prelude::*,
    process::{nsproxy::NsProxy, signal::SigStack, UserNamespace},
    vm::vmar::Vmar,
};
...
impl ThreadLocal {
    ...
    pub fn borrow_ns_proxy_mut(&self) -> NsProxyRefMut {
...
pub type NsProxyRefMut<'a> = ThreadLocalOptionRefMut<'a, Arc<NsProxy>>;
