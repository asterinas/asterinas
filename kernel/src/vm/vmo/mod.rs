...
pub(super) struct Vmo_ {
    ...
    writable_mapping_status: Option<Arc<WritableMappingStatus>>,
}
...
impl<R> Vmo<R> {
    ...
    pub fn writable_mapping_status(&self) -> &Option<Arc<WritableMappingStatus>> {
...
impl WritableMappingStatus {
    ...
    pub fn deny(&self) -> Result<()> {
        ...
        self.0
            ...
            .map_err(|_| Error::new(Errno::EBUSY))?;
        Ok(())
    }

    /// Increment the writable mapping counter.
    ///
    ...
    /// Decrement the writable mapping counter.
    ///
