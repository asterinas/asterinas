...
// Taken from <https://github.com/torvalds/linux/blob/46132e3/include/linux/sched/loadavg.h>
fn calc_loadavg(actual_load: FixedPoint, exp: FixedPoint, new_load: FixedPoint) -> FixedPoint {
    actual_load * exp + new_load * (FixedPoint::ONE - exp)
}
