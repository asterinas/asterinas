...
pub(super) fn init_in_first_kthread() {
    ...
    let mut timer_locked = coarse_instant_timer.lock();
    timer_locked.set_interval(Duration::from_millis(100));
    timer_locked.set_timeout(Timeout::After(Duration::from_millis(100)));
}
