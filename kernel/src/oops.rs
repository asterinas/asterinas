...
//!
//! In Asterinas, a Rust panic leads to a kernel "oops". The kernel "oops"
//! behaves as an exceptional control flow event. If kernel "oops" happened too
//! many times, the kernels panic and the system gets halted.
//!
