...
impl PageCacheBackend for RamInode {
    fn read_page_async(&self, _idx: usize, frame: &ExternalFrame) -> Result<BioWaiter> {
    ...
    fn write_page_async(&self, _idx: usize, _frame: &ExternalFrame) -> Result<BioWaiter> {
        // do nothing
        Ok(BioWaiter::new())
    }
