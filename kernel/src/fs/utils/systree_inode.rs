...
pub(in crate::fs) trait KernelFsInode: Send + Sync + 'static {
        ...
        Self: Sized + 'static,
    {
        ...
        let InnerNode::Branch(branch_node) = &inner_node else {
        ...
        Self: Sized + 'static,
    {
        ...
        let InnerNode::Leaf(leaf_node) = &inner_node else {
...
impl<KInode: KernelFsInode> Iterator for ThisAndParentDentryIter<'_, KInode> {
    type Item = Dentry;
