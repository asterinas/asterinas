...
use super::{
    entry::{EntryKey, EpollEntry, ReadySet},
    EpollCtl, EpollEvent, EpollFlags,
};
use crate::{
    events::IoEvents,
    fs::{file_handle::FileLike, file_table::FileDesc, utils::IoctlCmd},
    prelude::*,
...
struct EntryHolder(Arc<EpollEntry>);
...
impl From<Arc<EpollEntry>> for EntryHolder {
