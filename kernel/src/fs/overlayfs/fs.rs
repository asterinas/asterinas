...
use crate::{
    fs::{
        ...
        utils::{
            ...
            InodeType, IoctlCmd, Metadata, MknodType, ReadLinkResult, SuperBlock, XattrName,
            XattrNamespace, XattrSetFlags, NAME_MAX, XATTR_VALUE_MAX_LEN,
        },
    },
    prelude::*,
    process::{Gid, Uid},
...
mod tests {
    ...
    fn basic_operations() {
        ...
        assert_eq!(
            link.read_link().unwrap().into_real().unwrap(),
            link_str.to_string()
        );
    }
}
