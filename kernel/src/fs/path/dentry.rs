...
impl Dentry {
    ...
    ///
    /// The creation of the `inode` within the child `Dentry` depends on the implementation
    /// of the specific methods in the current `inode`.
    ...
    /// Creates a child `Dentry` through the inner `mknod` method.
