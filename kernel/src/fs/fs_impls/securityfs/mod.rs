...
use crate::{
    fs::{
        ...
        vfs::{
            ...
            inode::{
                Extension, FileOps, Inode, Metadata, MknodType, RevalidationPolicy, SymbolicLink,
            },
    ...
    fn entries(&self) -> Vec<SecurityFsEntry> {
        match self.kind {
            ...
            SecurityFsNodeKind::FeatureDomainDir => vec![
                ...
                SecurityFsEntry::new("stack", SecurityFsNodeKind::FeatureDomainStack),
                SecurityFsEntry::new("version", SecurityFsNodeKind::FeatureDomainVersion),
                SecurityFsEntry::new(
                    "fix_binfmt_elf_mmap",
                    SecurityFsNodeKind::FeatureDomainFixBinfmtElfMmap,
                ),
                SecurityFsEntry::new(
                    "post_nnp_subset",
                    SecurityFsNodeKind::FeatureDomainPostNnpSubset,
                ),
                SecurityFsEntry::new(
                    "computed_longest_left",
                    SecurityFsNodeKind::FeatureDomainComputedLongestLeft,
                ),
            ],
            _ => Vec::new(),
        }
...
impl FileOps for SecurityFsInode {
    fn read_at(
        ...
        match self.kind {
            ...
            | SecurityFsNodeKind::FeatureDomainChangeProfile
            | SecurityFsNodeKind::FeatureDomainChangeOnexec
            | SecurityFsNodeKind::FeatureDomainStack
            | SecurityFsNodeKind::FeatureDomainFixBinfmtElfMmap
            | SecurityFsNodeKind::FeatureDomainPostNnpSubset
            | SecurityFsNodeKind::FeatureDomainComputedLongestLeft => {
                writeln!(printer, "yes")?;
...
enum SecurityFsNodeKind {
    ...
    FeatureDomainFixBinfmtElfMmap,
    FeatureDomainPostNnpSubset,
    FeatureDomainComputedLongestLeft,
}
...
impl SecurityFsNodeKind {
    fn type_(self) -> InodeType {
        match self {
            ...
            | Self::FeatureDomainStack
            | Self::FeatureDomainVersion
            | Self::FeatureDomainFixBinfmtElfMmap
            | Self::FeatureDomainPostNnpSubset
            | Self::FeatureDomainComputedLongestLeft => InodeType::File,
        }
    }
    ...
    fn mode(self) -> InodeMode {
        match self {
            ...
            | Self::FeatureDomainFixBinfmtElfMmap
            | Self::FeatureDomainPostNnpSubset
            | Self::FeatureDomainComputedLongestLeft => mkmod!(a+r),
