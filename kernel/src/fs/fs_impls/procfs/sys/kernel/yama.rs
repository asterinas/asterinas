...
use crate::{
    fs::{
        file::mkmod,
        procfs::template::{
            BUF_SIZE_I32, DirOps, FileOps, ProcDir, ProcDirBuilder, ProcFileBuilder,
            lookup_child_from_table, populate_children_from_table,
        },
        vfs::inode::Inode,
    },
    prelude::*,
    process::posix_thread::alien_access::{get_yama_scope, set_yama_scope},
};
...
impl FileOps for PtraceScopeFileOps {
    fn read_at(&self, offset: usize, writer: &mut VmWriter) -> Result<usize> {
        ...
        writeln!(printer, "{}", get_yama_scope())?;
