        ...
        match mode {
            ...
            FallocMode::PunchHoleKeepSize => {
                ...
                if block_aligned_start < block_aligned_end {
                    ...
                    inner.punch_hole(start_bid, nblocks)?;
                    inner
                        .page_cache
...
impl InodeInner {
    ...
    pub fn punch_hole(&mut self, start_bid: Ext2Bid, nblocks: usize) -> Result<()> {
        self.inode_impl.punch_hole(start_bid, nblocks)
    }
...
impl InodeImpl {
    ...
    /// Returns whether any sparse blocks were found and allocated.
    ...
    pub fn punch_hole(&mut self, start_bid: Ext2Bid, nblocks: usize) -> Result<()> {
        let end_bid = start_bid + nblocks as Ext2Bid;
        self.dealloc_range_blocks(start_bid..end_bid);
