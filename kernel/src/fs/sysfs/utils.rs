...
///
/// This node can have children but does not have any specific attributes or behaviors
/// beyond those defined in [`SysBranchNodeFields`], and this node cannot be used as a
/// root node in the `SysTree`.
#[derive(Debug)]
...
impl BasicBranchNode {
    /// Creates a new `BasicBranchNode` with the given name and [`SysPerms`].
    pub fn new(name: SysStr, perms: SysPerms) -> Arc<Self> {
