...
use aster_systree::{
    ...
    SysNode, SysNodeId, SysNodeType, SysObj, SysStr,
};
...
impl BasicBranchNode {
    /// Creates a new `BasicBranchNode` with the given name and attribute set.
    pub fn new(name: SysStr, inode_mode: InodeMode) -> Arc<Self> {
