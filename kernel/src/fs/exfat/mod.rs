...
mod test {
    ...
    use ostd::{
        mm::{ExternalSegment, FrameAllocOptions, VmIo, PAGE_SIZE},
        prelude::*,
    };
    ...
    struct ExfatMemoryBioQueue(ExternalSegment);

    impl ExfatMemoryBioQueue {
        pub fn new(segment: ExternalSegment) -> Self {
    ...
    fn new_vm_segment_from_image() -> ExternalSegment {
