...
impl_syscall_nums_and_dispatch_fn! {
    ...
    SYS_MMAP = 9               => sys_mmap(args[..6], thread_info);
    ...
    SYS_RT_SIGPROCMASK = 14    => sys_rt_sigprocmask(args[..4], thread_info);
    SYS_RT_SIGRETURN = 15      => sys_rt_sigreturn(args[..0], thread_info, &mut context);
    SYS_IOCTL = 16             => sys_ioctl(args[..3], thread_info);
    ...
    SYS_SCHED_YIELD = 24       => sys_sched_yield(args[..0], thread_info);
    SYS_MADVISE = 28           => sys_madvise(args[..3], thread_info);
    ...
    SYS_GETPID = 39            => sys_getpid(args[..0], thread_info);
    ...
    SYS_GETSOCKOPT = 55        => sys_getsockopt(args[..5], thread_info);
    SYS_CLONE = 56             => sys_clone(args[..5], thread_info, &context);
    SYS_FORK = 57              => sys_fork(args[..0], thread_info, &context);
    SYS_EXECVE = 59            => sys_execve(args[..3], thread_info, &mut context);
    SYS_EXIT = 60              => sys_exit(args[..1]);
    SYS_WAIT4 = 61             => sys_wait4(args[..4]);
    SYS_KILL = 62              => sys_kill(args[..2]);
    SYS_UNAME = 63             => sys_uname(args[..1]);
    SYS_FCNTL = 72             => sys_fcntl(args[..3], thread_info);
    ...
    SYS_GETDENTS = 78          => sys_getdents(args[..3], thread_info);
    ...
    SYS_GETRUSAGE = 98         => sys_getrusage(args[..2], thread_info);
    ...
    SYS_GETPPID = 110          => sys_getppid(args[..0], thread_info);
    SYS_GETPGRP = 111          => sys_getpgrp(args[..0], thread_info);
    ...
    SYS_GETSID = 124           => sys_getsid(args[..1], thread_info);
    ...
    SYS_ARCH_PRCTL = 158       => sys_arch_prctl(args[..2], thread_info, &mut context);
    ...
    SYS_GETDENTS64 = 217       => sys_getdents64(args[..3], thread_info);
    ...
    SYS_EXECVEAT = 322         => sys_execveat(args[..5], thread_info, &mut context);
    SYS_PREADV2 = 327          => sys_preadv2(args[..5]);
    SYS_PWRITEV2 = 328         => sys_pwritev2(args[..5]);
    SYS_CLONE3 = 435           => sys_clone3(args[..2], thread_info, &context);
}
