...
impl_syscall_nums_and_dispatch_fn! {
    SYS_READ = 0               => sys_read(args[..3], current);
    SYS_WRITE = 1              => sys_write(args[..3], current);
    SYS_OPEN = 2               => sys_open(args[..3], current);
    SYS_CLOSE = 3              => sys_close(args[..1], current);
    SYS_STAT = 4               => sys_stat(args[..2], current);
    SYS_FSTAT = 5              => sys_fstat(args[..2], current);
    SYS_LSTAT = 6              => sys_lstat(args[..2], current);
    SYS_POLL = 7               => sys_poll(args[..3]);
    SYS_LSEEK = 8              => sys_lseek(args[..3]);
    SYS_MMAP = 9               => sys_mmap(args[..6], current);
    SYS_MPROTECT = 10          => sys_mprotect(args[..3]);
    SYS_MUNMAP = 11            => sys_munmap(args[..2]);
    SYS_BRK = 12               => sys_brk(args[..1]);
    SYS_RT_SIGACTION = 13      => sys_rt_sigaction(args[..4], current);
    SYS_RT_SIGPROCMASK = 14    => sys_rt_sigprocmask(args[..4]);
    SYS_RT_SIGRETURN = 15      => sys_rt_sigreturn(args[..0], current, &mut context);
    ...
    SYS_PIPE = 22              => sys_pipe(args[..1], current);
    ...
    SYS_CLONE = 56             => sys_clone(args[..5], current, &context);
    SYS_FORK = 57              => sys_fork(args[..0], current, &context);
    SYS_EXECVE = 59            => sys_execve(args[..3], current, &mut context);
    SYS_EXIT = 60              => sys_exit(args[..1]);
    SYS_WAIT4 = 61             => sys_wait4(args[..4]);
    SYS_KILL = 62              => sys_kill(args[..2]);
    SYS_UNAME = 63             => sys_uname(args[..1]);
    SYS_FCNTL = 72             => sys_fcntl(args[..3], current);
    ...
    SYS_CREAT = 85             => sys_creat(args[..2], current);
    ...
    SYS_GETRUSAGE = 98         => sys_getrusage(args[..2], current);
    SYS_GETUID = 102           => sys_getuid(args[..0], current);
    SYS_GETGID = 104           => sys_getgid(args[..0], current);
    SYS_SETUID = 105           => sys_setuid(args[..1]);
    SYS_SETGID = 106           => sys_setgid(args[..1]);
    SYS_GETEUID = 107          => sys_geteuid(args[..0], current);
    SYS_GETEGID = 108          => sys_getegid(args[..0], current);
    SYS_SETPGID = 109          => sys_setpgid(args[..2], current);
    SYS_GETPPID = 110          => sys_getppid(args[..0], current);
    SYS_GETPGRP = 111          => sys_getpgrp(args[..0], current);
    ...
    SYS_ARCH_PRCTL = 158       => sys_arch_prctl(args[..2], current, &mut context);
    ...
    SYS_OPENAT = 257           => sys_openat(args[..4], current);
    ...
    SYS_FSTATAT = 262          => sys_fstatat(args[..4], current);
    ...
    SYS_SET_ROBUST_LIST = 273  => sys_set_robust_list(args[..2], current);
    ...
    SYS_EXECVEAT = 322         => sys_execveat(args[..5], current, &mut context);
    SYS_PREADV2 = 327          => sys_preadv2(args[..5]);
    SYS_PWRITEV2 = 328         => sys_pwritev2(args[..5]);
    SYS_CLONE3 = 435           => sys_clone3(args[..2], current, &context);
}
