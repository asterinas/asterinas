...
///   of the first kernel thread on the BSP and initializes subsystems that
///   require kernel thread support, such as work queues, network stack,
...
///   and initializes components that require full process functionality,
