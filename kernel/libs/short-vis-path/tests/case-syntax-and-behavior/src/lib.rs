...
#![expect(
    dead_code,
    reason = "unexported types and constants are considered being used for testing"
)]
...
pub mod test_outer_attribute {
    ...
    // But rust-analyzer complains "failed to write request: The length of a sequence must be known",
