...
fn encode_as_address_offset(location: &PciDeviceLocation) -> u32 {
    // We only support ECAM here for AArch64 platforms. Offsets are from
...
///
/// On AArch64, the starting address of the memory bar of the PCI device
...
pub(crate) const MSIX_DEFAULT_MSG_ADDR: u32 = 0x0802_0000;
