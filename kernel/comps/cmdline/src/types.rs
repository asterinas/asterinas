...
use crate::{ParamError, ParseParamValue};
...
impl CpuList {
    ...
    /// Expand to concrete CPU IDs, returning at most `max_elems` elements.
    ///
    ...
    pub fn expand_bounded(&self, max_elems: usize) -> Result<Vec<u32>, ParamError> {
        ...
        let push_or_done = |out: &mut Vec<u32>, cpu: u32| -> bool {
