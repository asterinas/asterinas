...
bitflags::bitflags! {
    /// KMS client capabilities enabled for this open DRM file through
    /// `DRM_IOCTL_SET_CLIENT_CAP`.
    ///
    /// These bit positions are internal to Asterinas and do not correspond
    /// to DRM UAPI capability values.
