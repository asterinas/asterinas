...
use aster_pci::{PciDeviceId, bus::PciDevice, cfg_space::Bar, common_device::PciCommonDevice};
...
impl NVMePciTransport {
    ...
    pub(crate) fn write_reg32(&self, reg: NVMeRegs32, val: u32) -> Result<(), NVMeTransportError> {
        self.write_u32(reg as u32, val)
    }

    pub(crate) fn write_reg64(&self, reg: NVMeRegs64, val: u64) -> Result<(), NVMeTransportError> {
