...
impl InputDevice {
    ...
    pub fn init(mut transport: Box<dyn VirtioTransport>) -> Result<(), VirtioDeviceError> {
        ...
        // Registers with the input subsystem.
...
/// Maps key code to KeyCode enum.
fn map_to_key_code(linux_code: u16) -> Option<KeyCode> {
...
/// Maps relative axis code to RelCode enum.
fn map_to_rel_code(linux_code: u16) -> Option<RelCode> {
    Some(match linux_code {
        0x00 => RelCode::RelX,
        0x01 => RelCode::RelY,
        0x02 => RelCode::RelZ,
...
impl InputDevice {
    ...
    fn query_and_set_capabilities(&mut self) {
        ...
        // Queries and sets key capabilities.
        ...
        // Queries and sets relative axis capabilities.
