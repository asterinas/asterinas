...
fn test_pod_derive_simple() {
    ...
    assert_eq!(bytes.len(), core::mem::size_of::<S1>());
...
fn test_pod_derive_generic() {
    ...
    assert_eq!(bytes.len(), core::mem::size_of::<Item<u64>>());
