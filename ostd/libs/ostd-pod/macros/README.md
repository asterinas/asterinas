...
Procedural macros for the [`ostd-pod`](https://docs.rs/ostd-pod/) crate.
...
The `#[derive(Pod)]` macro is a convenience wrapper that automatically derives the required [zerocopy](https://docs.rs/zerocopy/) traits for POD types. 
...
- Derives the necessary [zerocopy](https://docs.rs/zerocopy/) traits
...
For detailed usage examples, see the crate [ostd-pod](https://docs.rs/ostd-pod/) documentation.
