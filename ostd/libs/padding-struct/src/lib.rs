...
/// struct MyStruct {
///     a: u8,
///     pub __pad1: [u8; const { core::mem::offset_of!(__MyStruct__, b) - core::mem::offset_of!(__MyStruct__, a) - size_of::<u8>() }],
///     b: u32,
///     pub __pad2: [u8; const { size_of::<__MyStruct__>() - core::mem::offset_of!(__MyStruct__, b) - size_of::<u32>() }],
/// }
/// ```
///
...
pub fn padding_struct(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    for (i, field) in field_vec.iter().enumerate() {
        ...
        // Add padding field with inline const block, inheriting cfg attributes
        padded_fields.push(quote! {
            #[allow(missing_docs)]
