...
fn test_basic_padding() {
    ...
    let padded = TestStruct {
        a: 1,
        __pad1: [0; {
            core::mem::offset_of!(__TestStruct__, b)
                - core::mem::offset_of!(__TestStruct__, a)
                - core::mem::size_of::<u8>()
        }],
        b: 2,
        __pad2: [0; {
            core::mem::offset_of!(__TestStruct__, c)
                - core::mem::offset_of!(__TestStruct__, b)
                - core::mem::size_of::<u32>()
        }],
        c: 3,
        __pad3: [0; {
            core::mem::size_of::<__TestStruct__>()
                - core::mem::offset_of!(__TestStruct__, c)
...
fn test_single_field() {
    ...
    let single = SingleField {
        value: 42,
        __pad1: [0; {
            core::mem::size_of::<__SingleField__>()
                - core::mem::offset_of!(__SingleField__, value)
...
fn test_multiple_fields() {
    ...
    let multi = MultiField {
        a: 1,
        __pad1: [0; {
            core::mem::offset_of!(__MultiField__, b)
                - core::mem::offset_of!(__MultiField__, a)
                - core::mem::size_of::<u8>()
        }],
        b: 2,
        __pad2: [0; {
            core::mem::offset_of!(__MultiField__, c)
                - core::mem::offset_of!(__MultiField__, b)
                - core::mem::size_of::<u16>()
        }],
        c: 3,
        __pad3: [0; {
            core::mem::offset_of!(__MultiField__, d)
                - core::mem::offset_of!(__MultiField__, c)
                - core::mem::size_of::<u32>()
        }],
        d: 4,
        __pad4: [0; {
            core::mem::size_of::<__MultiField__>()
                - core::mem::offset_of!(__MultiField__, d)
                - core::mem::size_of::<u64>()
        }],
    };
...
fn test_with_field_docs() {
    ...
    let doc = Documented {
        first: 10,
        __pad1: [0; {
            core::mem::offset_of!(__Documented__, second)
                - core::mem::offset_of!(__Documented__, first)
                - core::mem::size_of::<u8>()
        }],
        second: 20,
        __pad2: [0; {
            core::mem::size_of::<__Documented__>()
                - core::mem::offset_of!(__Documented__, second)
                - core::mem::size_of::<u32>()
        }],
    };
...
fn test_offset_consistency() {
    ...
    let ref_a_offset = core::mem::offset_of!(__OffsetTest__, a);
    let ref_b_offset = core::mem::offset_of!(__OffsetTest__, b);
...
fn test_padding_zero_filled() {
    ...
    let zero_pad = ZeroPadded {
        a: 255,
        __pad1: [0; {
            core::mem::offset_of!(__ZeroPadded__, b)
                - core::mem::offset_of!(__ZeroPadded__, a)
                - core::mem::size_of::<u8>()
        }],
        b: 0xFFFFFFFF,
        __pad2: [0; {
            core::mem::size_of::<__ZeroPadded__>()
                - core::mem::offset_of!(__ZeroPadded__, b)
                - core::mem::size_of::<u32>()
        }],
    };
...
fn test_zerocopy_derive() {
    ...
    let from_bytes: &ZerocopyStruct =
        FromBytes::ref_from_bytes(&bytes[..core::mem::size_of::<ZerocopyStruct>()]).unwrap();
    ...
    let test_struct = ZerocopyStruct {
        a: 42,
        __pad1: [0; {
            core::mem::offset_of!(__ZerocopyStruct__, b)
                - core::mem::offset_of!(__ZerocopyStruct__, a)
                - core::mem::size_of::<u8>()
        }],
        b: 0xDEADBEEF,
        __pad2: [0; {
            core::mem::offset_of!(__ZerocopyStruct__, c)
                - core::mem::offset_of!(__ZerocopyStruct__, b)
                - core::mem::size_of::<u32>()
        }],
        c: 0x1234,
        __pad3: [0; {
            core::mem::size_of::<__ZerocopyStruct__>()
                - core::mem::offset_of!(__ZerocopyStruct__, c)
                - core::mem::size_of::<u16>()
        }],
    };
