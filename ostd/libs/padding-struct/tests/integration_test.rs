...
fn repr_align_preserved() {
    ...
    let aligned = AlignedStruct {
        a: 1,
        __pad1: [0; {
            core::mem::offset_of!(__AlignedStruct__, b)
                - core::mem::offset_of!(__AlignedStruct__, a)
                - size_of::<u8>()
        }],
        b: 2,
        __pad2: [0; {
            size_of::<__AlignedStruct__>()
                - core::mem::offset_of!(__AlignedStruct__, b)
                - size_of::<u32>()
        }],
    };
