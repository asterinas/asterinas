...
/// Returns the difference between the real load address and the one specified in the link script.
pub fn image_load_offset() -> isize {
    /// The load address of the `entry_legacy32` symbol specified in the link script.
