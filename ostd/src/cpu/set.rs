...
impl AtomicCpuSet {
    ...
    /// new value and a portion of the old value. Loads on each specific
    /// CPU state are atomic, and follows the specified ordering.
    ///
    ...
    /// new value and a portion of the old value. Stores on each specific
    /// CPU state are atomic, and follows the specified ordering.
