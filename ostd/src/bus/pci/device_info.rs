...
impl PciDeviceLocation {
    ...
    /// By encoding bus, device, and function into u32, user can access a PCI device in x86 by passing in this value to the address port.
    #[inline(always)]
    pub fn encode_as_x86_port_value(&self) -> u32 {
    ...
    /// By encoding bus, device, and function into u32, user can access a PCI device by accessing the returned address.
    #[inline(always)]
    pub fn encode_as_address_value(&self) -> u32 {
