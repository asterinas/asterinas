...
pub fn init_kernel_page_table(meta_pages: Segment<MetaPageMeta>) {
    ...
    // In the LoongArch64, we don't need to do linear mappings for the kernel because of DMW0.
    #[cfg(not(target_arch = "loongarch64"))]
    ...
    // In the LoongArch64, we don't need to do linear mappings for the kernel code because of DMW0.
    #[cfg(not(target_arch = "loongarch64"))]
