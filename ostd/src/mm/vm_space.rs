...
use crate::{
    ...
    mm::{
        ...
        Frame, PageProperty, UntypedMeta, VmReader, VmWriter, MAX_USERSPACE_VADDR,
    },
    prelude::*,
...
/// memory ([`Frame<dyn UntypedMeta>`]s) to the `VmSpace` using the cursor.
///
...
impl CursorMut<'_, '_> {
    ...
    pub fn map(&mut self, frame: Frame<dyn UntypedMeta>, prop: PageProperty) {
