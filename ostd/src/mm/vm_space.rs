...
use crate::{
    ...
    mm::{
        ...
        ExternalFrame, PageProperty, VmReader, VmWriter, MAX_USERSPACE_VADDR,
    },
    prelude::*,
...
/// memory ([`ExternalFrame`]s) to the `VmSpace` using the cursor.
///
...
impl CursorMut<'_, '_> {
    ...
    pub fn map(&mut self, frame: ExternalFrame, prop: PageProperty) {
