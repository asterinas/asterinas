...
//! (e.g., `&[u8]`) or untyped memory (e.g, [`Frame<dyn UntypedMeta>`]). Behind the scene, `VmReader` and `VmWriter`
...
//!
//! [`Frame<dyn UntypedMeta>`]: crate::mm::Frame<dyn UntypedMeta>
...
/// e.g., [`Segment<dyn UntypedMeta>`], [`Vec<Frame<dyn UntypedMeta>>`] and [`Frame<dyn UntypedMeta>`].
///
/// # Concurrency
///
...
/// for such properties.
///
/// [`Segment<dyn UntypedMeta>`]: crate::mm::Segment<dyn UntypedMeta>
/// [`Frame<dyn UntypedMeta>`]: crate::mm::Frame<dyn UntypedMeta>
