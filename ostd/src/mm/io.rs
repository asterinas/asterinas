...
//! (e.g., `&[u8]`) or untyped memory (e.g, [`ExternalFrame`]). Behind the scene, `VmReader` and `VmWriter`
...
//!
//! [`ExternalFrame`]: crate::mm::ExternalFrame
...
/// e.g., [`ExternalSegment`], [`Vec<ExternalFrame>`] and [`ExternalFrame`].
///
/// # Concurrency
///
...
/// for such properties.
///
/// [`ExternalSegment`]: crate::mm::ExternalSegment
/// [`ExternalFrame`]: crate::mm::ExternalFrame
