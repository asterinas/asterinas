...
bitflags! {
    ...
    pub(crate) struct PrivilegedPageFlags: u8 {
        ...
        /// The first bit available for software use in privileged context.
        /// This flag is reserved for OSTD to distinguish between the tracked
        /// memory and I/O memory. The flag should not be used by user code.
