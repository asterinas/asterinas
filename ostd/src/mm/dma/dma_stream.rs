...
use crate::{
    ...
    mm::{
        ...
        ExternalSegment, HasPaddr, Infallible, Paddr, VmIo, VmReader, VmWriter, PAGE_SIZE,
    },
};
...
impl DmaStream {
    /// Establishes DMA stream mapping for a given [`ExternalSegment`].
    ///
    ...
    /// Gets the underlying [`ExternalSegment`].
    ///
    ...
    pub fn vm_segment(&self) -> &ExternalSegment {
