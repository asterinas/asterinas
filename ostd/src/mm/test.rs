...
use crate::{
    mm::{
        ...
        FallibleVmRead, FallibleVmWrite, FrameAllocOptions, VmSpace,
    },
    prelude::*,
    Error,
};
...
mod io {
    ...
    /// Tests handling invalid reader/writer in Fallible mode.
    #[ktest]
    ...
    /// Tests handling invalid collect in Fallible mode.
    #[ktest]
