...
///  - The metadata system is initialized and [`BootPageTable::initialize_frame_metadata`]
///    is called during metadata initialization.  
...
const PTE_HAS_INIT_FRAME_META: PageFlags = PageFlags::AVAIL2;
    ...
    unsafe fn from_current_pt() -> Self {
        ...
        dfs_walk_on_leave::<E, C>(root_pt, C::NR_LEVELS, &mut |pte: &mut E| {
            ...
            pte.set_prop(PageProperty::new(
                (prop.flags | PTE_POINTS_TO_FIRMWARE_PT) - PTE_HAS_INIT_FRAME_META,
                prop.cache,
            ));
        });
        Self {
