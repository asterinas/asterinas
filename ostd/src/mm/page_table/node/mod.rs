...
use crate::{
    mm::{
        ...
        page_table::{load_pte, store_pte, PteScalar},
...
/// [`PageTableGuard`].
pub(super) type PageTableNode<C> = Frame<PageTableFrameMeta<C>>;
...
pub(super) type PageTableNodeRef<'a, C> = FrameRef<'a, PageTableFrameMeta<C>>;
