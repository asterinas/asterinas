...
pub fn call_ostd_main() -> ! {
    ...
    unsafe {
        ...
        use crate::task::{set_scheduler, Scheduler, Task, TaskOptions};
        ...
        /// A simple FIFO (First-In-First-Out) task scheduler for the unit tests.
        impl Scheduler for VecDeque<Arc<Task>> {
        ...
        let simple_scheduler = Box::new(VecDeque::<Arc<Task>>::new());
