...
mod test {
    ...
    /// Macro to check counter values for multiple ranges
    /// Usage: check_counter_values!(counter, [15..20, 1], [20..30, 2], [30..35, 1])
    ...
    #[ktest]
    fn test_add_remove_overlapping_beginning() {
        let mut counter = RangeCounter::new();
        let range1 = 10..15;
        let range2 = 3..13;
    ...
    #[ktest]
    fn test_add_remove_overlapping_end() {
        let mut counter = RangeCounter::new();
        let range1 = 10..15;
        let range2 = 12..18;
    ...
    #[ktest]
    fn test_add_remove_partial_overlap() {
        let mut counter = RangeCounter::new();
        let range1 = 5..15;
        let range2 = 10..20;
