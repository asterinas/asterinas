...
impl IoMem<Sensitive> {
    ...
    /// # Safety
    ///
    /// The caller must ensure that the offset is valid, e.g., follows the specification when used
    /// for implementing drivers and does not cause any out-of-bounds access.
