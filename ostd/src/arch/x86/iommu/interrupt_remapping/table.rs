...
use crate::{
    mm::{paddr_to_vaddr, ExternalSegment, FrameAllocOptions, PAGE_SIZE},
...
impl IntRemappingTable {
    ...
    /// Creates an Interrupt Remapping Table with one ExternalFrame (default).
