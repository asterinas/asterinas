...
impl Clone for FpuState {
    fn clone(&self) -> Self {
        let mut state_area = Box::new(XSaveArea::init());
...
impl XSaveArea {
    fn init() -> Self {
        ...
        // Set the init values for the FPU state. Refer to Intel SDM, Table 11-1:
        ...
        xsave_area.fxsave_area.status = 0xFFFF;
