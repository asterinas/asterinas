...
use crate::cpu::local::{CpuLocal, StaticStorage};
...
pub(super) unsafe fn init() {
    let tss_ptr = LOCAL_TSS.storage.as_ptr();
...
static LOCAL_TSS: CpuLocal<TaskStateSegment, StaticStorage<TaskStateSegment>> = {
