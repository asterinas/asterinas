...
use crate::{
    exception::handler::user_mode_exception_handler,
...
impl crate::arch::tdx_guest::TdxTrapFrame for GeneralRegs {
    fn rax(&self) -> usize {
        self.rax
    }
...
define_cpu_exception!(
    ...
    [Debug = 1, FaultOrTrap],
    [NonMaskableInterrupt = 2, Interrupt],
    [Breakpoint = 3, Trap],
    [Overflow = 4, Trap],
    ...
    // User-interpreted interrupts
    [Syscall = 256, Interrupt]
);
