...
/// heap and kernel page table are initialized.
///
/// # Safety
///
/// 1. This function should be called only once in the boot context of the
///    bootstrapping processor.
/// 2. This function should be called after the heap and kernel page table is
///    initialized.
