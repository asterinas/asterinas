...
# build_pass_prompt.sh and print_guidelines.py use that snapshot by default.
# Progressive prompts also embed the resolved root in their drill-down command,
# so later guideline prints do not depend on ACR_GUIDELINE_ROOT inheritance.
