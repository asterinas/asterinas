...
//! Invalidation-related reigsters
...
pub struct InvalidationRegisters {
    ...
    pub(super) completion_event_control: Volatile<&'static mut u32, ReadWrite>,
    pub(super) completion_event_data: Volatile<&'static mut u32, ReadWrite>,
    pub(super) completion_event_addr: Volatile<&'static mut u32, ReadWrite>,
    pub(super) completion_event_upper_addr: Volatile<&'static mut u32, ReadWrite>,

    pub(super) queue_error_record: Volatile<&'static mut u64, ReadOnly>,

    pub(super) invalidate_address: Volatile<&'static mut u64, WriteOnly>,
    pub(super) iotlb_invalidate: Volatile<&'static mut u64, ReadWrite>,
}
...
impl InvalidationRegisters {
    ...
    pub(super) unsafe fn new(base_vaddr: Vaddr) -> Self {
        ...
        Self {
            ...
            completion_event_control: Volatile::new(&mut *((base_vaddr + 0xA0) as *mut u32)),
            completion_event_data: Volatile::new(&mut *((base_vaddr + 0xA4) as *mut u32)),
            completion_event_addr: Volatile::new(&mut *((base_vaddr + 0xA8) as *mut u32)),
            completion_event_upper_addr: Volatile::new(&mut *((base_vaddr + 0xAC) as *mut u32)),
            queue_error_record: Volatile::new_read_only(&mut *((base_vaddr + 0xB0) as *mut u64)),
            invalidate_address,
            iotlb_invalidate,
        }
    }
