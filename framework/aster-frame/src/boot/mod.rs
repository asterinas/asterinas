...
pub fn call_aster_main() -> ! {
    ...
    #[cfg(ktest)]
    {
        ...
        use ktest::runner::KtestResult;

        use crate::{
            arch::qemu::{exit_qemu, QemuExitCode},
            task::{set_scheduler, FifoScheduler, Scheduler, TaskOptions},
        };

        crate::init();
        crate::trap::enable_local();
        ...
        // Spawn the main task that will never return;
        let _ = TaskOptions::new(|| match ktesting::run_ktests() {
