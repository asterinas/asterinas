...
/// The order of `Priority` is inverted against the inner value.
/// Lower value means higher priority, and vice versa.
///
/// # Examples
///
/// ```
/// use aster_frame::task::Priority;
/// let p1 = Priority::new(110);
/// let p2 = Priority::new(120);
/// assert!(p1 > p2);
/// ```
...
pub fn nice_to_prio(nice: i8) -> Priority {
    let prio = (nice - 20) + Priority::normal().get() as i8;
    Priority::new(prio as u16)
}
