...
[llama.cpp](https://github.com/ggerganov/llama.cpp) is a high-performance LLM inference engine written in C++.

## TODO: vLLM

[vLLM](https://vllm.readthedocs.io/) is a high-throughput and memory-efficient LLM serving engine.
