...
- [Crates & Modules](rust-specific/crates-and-modules.md)
    ...
    - [`kernel-dependency-direction`](rust-specific/crates-and-modules.md#kernel-dependency-direction): Keep the kernel crate graph acyclic and do not introduce dependencies on higher layers.
    - [`component-placement`](rust-specific/crates-and-modules.md#component-placement): Place kernel crates according to their initialization role and dependency direction relative to `aster-core`.
