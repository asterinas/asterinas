...
- Introducing changes that affect user-space programs, such as adding a non-Linux system call.

Examples of changes that **do not** require an RFC include:
- Adding a new, well-understood feature like a standard Linux system call or a device driver.
- Refactoring or fixing bugs in existing code.
