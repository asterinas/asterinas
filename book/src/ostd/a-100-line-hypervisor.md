...
This minimal hypervisor can run the following Hello World assembly program in a guest.
The guest loops over the string and writes each character to COM1.
...
A sample implementation of the hypervisor kernel in safe Rust is given below.
