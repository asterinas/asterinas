...
[`DisabledPreemptGuard`](https://asterinas.github.io/api-docs/0.18.1/ostd/task/struct.DisabledPreemptGuard.html)
disables preemption for its lifetime,
and [`DisabledLocalIrqGuard`](https://asterinas.github.io/api-docs/0.18.1/ostd/irq/struct.DisabledLocalIrqGuard.html)
disables local IRQs
...
[`SpinLock`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.SpinLock.html), [`Mutex`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.Mutex.html), [`RwLock`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.RwLock.html), [`RwMutex`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.RwMutex.html), [`Rcu`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.Rcu.html), and [`WaitQueue`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.WaitQueue.html).
...
[`SpinLock::lock()`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.SpinLock.html#method.lock)
...
The kind of guard —
preemption-only ([`PreemptDisabled`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/enum.PreemptDisabled.html))
or IRQ-disabled ([`LocalIrqDisabled`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/enum.LocalIrqDisabled.html)) —
...
[`Rcu<P>`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.Rcu.html) provides lock-free read access with deferred reclamation:

- **Read side**:
  [`Rcu::read()`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.Rcu.html#method.read) disables preemption
  and loads the pointer with `Acquire` ordering.
  The read-side critical section is non-preemptible.
- **Write side**:
  [`Rcu::update(new_ptr)`](https://asterinas.github.io/api-docs/0.18.1/ostd/sync/struct.Rcu.html#method.update) atomically swaps the pointer
...
via [`CpuLocal::get_with(&irq_guard)`](https://asterinas.github.io/api-docs/0.18.1/ostd/cpu/local/struct.CpuLocal.html#method.get_with).
...
For `Sync` types,
[`CpuLocal::get_on_cpu(target_cpu)`](https://asterinas.github.io/api-docs/0.18.1/ostd/cpu/local/struct.CpuLocal.html#method.get_on_cpu) allows remote access without a guard
