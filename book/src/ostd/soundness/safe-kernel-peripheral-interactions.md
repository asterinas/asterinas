...
* **[`DmaCoherent`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/dma/struct.DmaCoherent.html)**: Cache-coherent DMA mapping.
  Created from a [`Segment<()>`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/segment/struct.Segment.html) (untyped).
* **[`DmaStream`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/dma/struct.DmaStream.html)**: Streaming DMA mapping.
  Created from a [`USegment`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/segment/type.USegment.html) (untyped).
...
OSTD's [`IoMem`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoMem.html) type has two sensitivity levels,
...
- `IoMem<Insensitive>`:
  ...
  Available to device drivers via [`IoMem::acquire(range)`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoMem.html#method.acquire).
...
I/O ports,
represented as [`IoPort`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoPort.html),
...
- [`IoPort::acquire(port)`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoPort.html#method.acquire) is the safe public API.
...
Device interrupts are managed through the [`IrqLine`](https://asterinas.github.io/api-docs/0.18.1/ostd/irq/struct.IrqLine.html) abstraction.
