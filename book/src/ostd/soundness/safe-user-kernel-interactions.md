...
entering/exiting user space ([`UserMode`](https://asterinas.github.io/api-docs/0.18.1/ostd/user/struct.UserMode.html), [`UserContext`](https://asterinas.github.io/api-docs/0.18.1/ostd/arch/cpu/context/struct.UserContext.html)),
managing user address spaces ([`VmSpace`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.VmSpace.html)),
and accessing user memory ([`VmReader<Fallible>`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/io/struct.VmReader.html), [`VmWriter<Fallible>`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/io/struct.VmWriter.html)).
...
[`UserMode::context()`](https://asterinas.github.io/api-docs/0.18.1/ostd/user/struct.UserMode.html#method.context)
and [`UserMode::context_mut()`](https://asterinas.github.io/api-docs/0.18.1/ostd/user/struct.UserMode.html#method.context_mut)
...
[`UserMode::execute(has_kernel_event)`](https://asterinas.github.io/api-docs/0.18.1/ostd/user/struct.UserMode.html#method.execute)
...
clients obtain a [`CursorMut`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.CursorMut.html)
via [`VmSpace::cursor_mut(guard, &range)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.VmSpace.html#method.cursor_mut),
...
- [`CursorMut::map(frame, prop)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.CursorMut.html#method.map)
  accepts a `UFrame` — an untyped frame.
  There is no code path that converts a typed `Frame<M>` to `UFrame`
  unless `M: AnyUFrameMeta`.
- [`CursorMut::map_iomem(io_mem, prop, len, offset)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.CursorMut.html#method.map_iomem)
...
[`VmSpace::reader(vaddr, len)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.VmSpace.html#method.reader)
and [`VmSpace::writer(vaddr, len)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.VmSpace.html#method.writer)
