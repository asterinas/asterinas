...
[`Scheduler<T>`](https://asterinas.github.io/api-docs/0.18.1/ostd/task/scheduler/trait.Scheduler.html) (global scheduling decisions)
and [`LocalRunQueue<T>`](https://asterinas.github.io/api-docs/0.18.1/ostd/task/scheduler/trait.LocalRunQueue.html) (per-CPU run queue management).
...
Even if the scheduler's [`LocalRunQueue::pick_next()`](https://asterinas.github.io/api-docs/0.18.1/ostd/task/scheduler/trait.LocalRunQueue.html#method.pick_next) returns a task
...
The frame allocator is injected via the [`GlobalFrameAllocator`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/allocator/trait.GlobalFrameAllocator.html) trait (safe).
...
**The defense**:
[`Frame::from_unused(paddr, metadata)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/struct.Frame.html#method.from_unused) enforces the invariant
...
The slab allocator is injected via the [`GlobalHeapAllocator`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/trait.GlobalHeapAllocator.html) trait (safe).
...
such as [`Slab`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/type.Slab.html) and [`HeapSlot`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/struct.HeapSlot.html)
...
[`SlabMeta::alloc()`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/struct.SlabMeta.html#method.alloc) increments
and [`Slab::dealloc(slot)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/type.Slab.html#method.dealloc) decrements `nr_allocated`.
...
from `SlabMeta::alloc()` or [`HeapSlot::alloc_large(size)`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/heap/struct.HeapSlot.html#method.alloc_large)
...
for [logging](https://asterinas.github.io/api-docs/0.18.1/ostd/log/logger/fn.inject_logger.html),
[power management](https://asterinas.github.io/api-docs/0.18.1/ostd/power/fn.inject_restart_handler.html),
[scheduling hooks](https://asterinas.github.io/api-docs/0.18.1/ostd/task/fn.inject_pre_schedule_handler.html),
[page fault handling](https://asterinas.github.io/api-docs/0.18.1/ostd/arch/trap/fn.inject_user_page_fault_handler.html),
[SMP boot](https://asterinas.github.io/api-docs/0.18.1/ostd/boot/smp/fn.register_ap_entry.html),
[interrupt bottom halves](https://asterinas.github.io/api-docs/0.18.1/ostd/irq/fn.register_bottom_half_handler_l1.html),
and [timer callbacks](https://asterinas.github.io/api-docs/0.18.1/ostd/timer/fn.register_callback_on_cpu.html).
