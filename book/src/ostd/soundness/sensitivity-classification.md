...
| User-mode registers (GP registers, user RFLAGS subset, FS base) | Insensitive | Cannot directly affect kernel state | Exposed via [`UserContext`](https://asterinas.github.io/api-docs/0.18.1/ostd/arch/cpu/context/struct.UserContext.html) with sanitization |
...
| User-space virtual memory | Insensitive | Kernel safety does not depend on it | Manipulated safely via [`VmSpace`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/vm_space/struct.VmSpace.html) |
| Untyped physical memory pages | Insensitive | Do not host Rust objects; accessed only via POD copy | Exposed as [`UFrame`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/untyped/type.UFrame.html) / [`USegment`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/frame/segment/type.USegment.html); used for user pages, DMA buffers |
...
| Resource | Classification | Rationale | OSTD Handling |
|----------|---------------|-----------|---------------|
| Local APIC | **Sensitive** | Can reset CPUs, mask interrupts | [`IoMem`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoMem.html)`<Sensitive>`, `pub(crate)` only |
...
| Peripheral MMIO (NIC, disk, USB, GPU) | Insensitive | Failure confined to the device | `IoMem<Insensitive>` via [`IoMem::acquire(range)`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoMem.html#method.acquire) |
| Peripheral I/O ports | Insensitive | Failure confined to the device | [`IoPort`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoPort.html) via [`IoPort::acquire(port)`](https://asterinas.github.io/api-docs/0.18.1/ostd/io/struct.IoPort.html#method.acquire) |
| Peripheral interrupts | Insensitive | Routed through OSTD's IRQ framework | [`IrqLine`](https://asterinas.github.io/api-docs/0.18.1/ostd/irq/struct.IrqLine.html) callback registration |
| DMA mappings | Insensitive | Restricted by IOMMU to untyped memory | [`DmaCoherent`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/dma/struct.DmaCoherent.html) / [`DmaStream`](https://asterinas.github.io/api-docs/0.18.1/ostd/mm/dma/struct.DmaStream.html) APIs |
