...
impl From<kxos_frame::Error> for Error {
    fn from(frame_error: kxos_frame::Error) -> Self {
        match frame_error {
            kxos_frame::Error::AccessDenied => Error::new(Errno::EFAULT),
            kxos_frame::Error::NoMemory => Error::new(Errno::ENOMEM),
            kxos_frame::Error::InvalidArgs => Error::new(Errno::EINVAL),
            kxos_frame::Error::IoError => Error::new(Errno::EIO),
