...
fn set_contain_where_clause(
    ...
    where_predicates.push(parse_quote!(
        #type_set: ::kxos_typeflags_util::SetContain<#required_type>
    ));
    where_predicates.push(parse_quote!(
        ::kxos_typeflags_util::SetContainOp<#type_set, #required_type>: ::kxos_typeflags_util::IsTrue
    ));
...
fn set_include_where_clause(
    ...
    additional_where_prediates.push(parse_quote!(
        #required_type_set: ::kxos_typeflags_util::Set
    ));
    additional_where_prediates.push(parse_quote!(
        #type_set: ::kxos_typeflags_util::SetInclude<#required_type_set>
    ));
    additional_where_prediates.push(parse_quote!(
                ::kxos_typeflags_util::SetIncludeOp<#type_set, #required_type_set>: ::kxos_typeflags_util::IsTrue
            ));
