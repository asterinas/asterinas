//！This crate defines the require procedural macros to implement capability for kxos.
//! When use this crate, kxos-typeflags and kxos-typeflags-util should also be added as dependency.
//!
