...
impl<'a> BioBuf<'a> {
    ...
    pub fn from_boxed_slice(boxed_slice: Box<[u8]>) -> Self {
        ...
        Self::Owned(boxed_slice)
    }

    pub fn into_boxed_slice(self) -> Box<[u8]> {
        match self {
            Self::Owned(boxed_slice) => boxed_slice,
            _ => panic!(),
        }
    }
    ...
    pub fn as_slice(&self) -> &[u8] {
        match self {
            ...
            Self::Owned(boxed_slice) => boxed_slice.as_ref(),
        }
    }
    ...
    pub fn as_mut_slice(&mut self) -> &mut [u8] {
        match self {
            Self::BorrowMut(slice_mut) => slice_mut,
            Self::Owned(boxed_slice) => boxed_slice.as_mut(),
            Self::Borrow(_) => panic!(),
        }
    }
    ...
    pub fn len(&self) -> usize {
        match self {
            ...
            Self::Owned(boxed_slice) => boxed_slice.len(),
        }
    }
