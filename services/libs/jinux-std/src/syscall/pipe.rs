use crate::fs::file_handle::{File, FileHandle};
use crate::fs::file_table::FileDescripter;
use crate::fs::utils::{Channel, Consumer, IoEvents, Poller, Producer, StatusFlags};
...
pub fn sys_pipe2(fds: Vaddr, flags: u32) -> Result<SyscallReturn> {
    ...
    let (reader, writer) = {
        ...
        .split();
        (PipeReader { consumer }, PipeWriter { producer })
    };
