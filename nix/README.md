...
On NixOS, enable envfs in the host configuration and rebuild the system
before using the development shell.
The build scripts use `/bin/bash`, which envfs resolves through the
