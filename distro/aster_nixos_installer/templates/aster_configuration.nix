  ...
  options = {
    aster_nixos = {
      ...
      break-into-stage-1-shell = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "If set to true, the system will not proceed to switch to the root filesystem after initial boot. Instead, it will drop into an initramfs shell. This is primarily intended for debugging purposes.";
      };
