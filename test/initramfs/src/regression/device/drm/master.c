...
FN_TEST(magic_authentication)
{
	...
	TEST_RES(get_drm_magic(client_fd, &first_magic), first_magic != 0);
	TEST_RES(get_drm_magic(client_fd, &second_magic),
		 second_magic == first_magic);
...
FN_TEST(magic_ids_are_unique_per_client)
{
	...
	TEST_RES(get_drm_magic(first_client_fd, &first_magic),
		 first_magic != 0);
	TEST_RES(get_drm_magic(second_client_fd, &second_magic),
		 second_magic != 0 && second_magic != first_magic);
