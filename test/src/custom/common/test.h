...
/*
 * A framework for writing custom tests.
 *
 * A custom test typically consists of two parts, the setup part and the
 ...
 *
 * The framework provides basic utilities for writing custom tests:
 *
