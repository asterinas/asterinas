...
fn install_setup_with_arch(
    ...
    cmd.env("RUSTFLAGS", "-Cdebug-info=3 -Ccode-model=kernel -Crelocation-model=pie -Ctarget-feature=+crt-static -Zplt=yes -Zrelax-elf-relocations=yes -Crelro-level=full");
