...
VIRTIOFS_RUNTIME_DIR=${VIRTIOFS_RUNTIME_DIR:-/tmp/asterinas-virtiofs}
VIRTIOFS_SOCKET=${VIRTIOFS_SOCKET:-"$VIRTIOFS_RUNTIME_DIR/vfs.sock"}
VIRTIOFS_SCRATCH_TAG=${VIRTIOFS_SCRATCH_TAG:-"aster-virtiofs-scratch"}
VIRTIOFS_SCRATCH_SOCKET=${VIRTIOFS_SCRATCH_SOCKET:-"$VIRTIOFS_RUNTIME_DIR/vfs-scratch.sock"}
